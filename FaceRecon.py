...
training_data_set='.\FaceTraining'
subjects = ["", "Georgs", "Trump"]
...
test1 = cv2.resize(predicted_img1, (960, 960))
test2 = cv2.resize(predicted_img2, (960, 960))  
cv2.imshow("output1", test1)
cv2.imshow("output2", test2)
cv2.waitKey(0)
cv2.destroyAllWindows()